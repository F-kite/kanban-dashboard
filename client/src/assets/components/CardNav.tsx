            ...
            >
              ...
              <div className="nav-card-links mt-auto flex flex-col gap-[2px]">
                {item.links?.map((lnk, i) => {
                  // Проверяем, является ли ссылка внутренней (начинается с /) или внешней
                  const isInternalLink = lnk.href.startsWith('/') && !lnk.href.startsWith('http') && !lnk.href.startsWith('mailto:');
